...
I'm a **MERN Full Stack Developer** who enjoys turning ideas into fast, reliable products — from pixel-perfect React interfaces to well-structured Node.js/Express APIs backed by MongoDB and MySQL, shipped to production on Vercel, Netlify, and Render. Alongside development, I sharpen my problem-solving through daily **Data Structures & Algorithms practice in Java**, treating it as a non-negotiable part of becoming a stronger engineer. I'm currently expanding into **AI/ML**, building the mathematical and practical foundation to design intelligent, data-driven systems. My goal is simple: keep building real-world projects, keep leveling up my fundamentals, and grow into a well-rounded engineer who can bridge full stack development with applied machine learning.
...
- 🎯 Preparing the groundwork for a move into AI/ML
...
> 🚀 *"Small consistent commits build big careers."*
